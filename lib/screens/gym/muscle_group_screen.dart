    ...
    await showDialog(
      ...
      builder: (context) {
        return StatefulBuilder(
          builder: (context, setLocalState) => _StyledDialog(
            ...
            content: Column(
              ...
              children: [
                ...
                TextField(
                  ...
                  decoration: _fieldDecoration('Reps (optional)', Icons.repeat_rounded),
                ),
                  ...
                  child: Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(child: Text(_dateFmt.format(selectedDate))),
